...
routerAdd(
  ...
  (e) => {
    // Correção "esperado": produtos de UPGRADE (troca de categoria
    // GOLD<->PLATINUM de um ingresso que a pessoa já tinha) contam como
    // transação no Guru/CSV mas NÃO são ingresso novo — o CSV de referência
    // infla o "esperado" em +1 (ou +2) pra quem fez upgrade. Snapshot tirado
    // do warehouse (Nekt) em 2026-07-21, somando as transações aprovadas dos
    // produtos:
    ...
    // Se houver upgrades novos depois desta data, este mapa fica
    // desatualizado — reconsultar o warehouse e regenerar caso a
    // reconciliação seja rodada de novo bem mais tarde.
